...
while(seat_found == false) {
	...
	seat_found = WebUI.callTestCase(findTestCase('Test Cases/All Seat Selection Patterens/IMAX 4 Seat Selection'), [('count_1'):2],
		FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Test Cases/Family Pack Selection/Functional Steps/Select a Family Pack'), null,
	FailureHandling.STOP_ON_FAILURE)
